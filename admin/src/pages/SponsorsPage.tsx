                            ...
                            <Table size="small">
                                <TableHead>
                                    <TableRow sx={{ '& th': { fontWeight: 700 } }}>
                                        ...
                                        <TableCell>Current value (EN)</TableCell>
                                        <TableCell>Edit in</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {[
                                        { key: 'announcement.text',     value: 'New: Outdoor Challenge 2026 is open for registration!' },
                                        { key: 'announcement.linkText', value: 'Learn more' },
                                        { key: 'announcement.href',     value: '/challenge/2026' },
                                    ].map(row => (
                                        <TableRow key={row.key}>
                                            <TableCell><Typography variant="caption" sx={{ fontFamily: 'monospace' }}>{row.key}</Typography></TableCell>
                                            <TableCell><Typography variant="caption" color="text.secondary">{row.value}</Typography></TableCell>
