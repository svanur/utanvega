...
function runDotnetUserSecrets(env) {
  ...
  execFileSync('dotnet', [...commonArgs, 'ConnectionStrings:DefaultConnection', `Host=localhost;Port=5432;Database=postgres;Username=postgres;Password=${env.postgresPassword};Include Error Detail=true`], {
    cwd: backendDir,
    stdio: 'inherit',
  });
...
async function setup() {
  ...
  console.log('Supabase: http://localhost:8000');
}
