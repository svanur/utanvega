...
export class QuoteService {
    private static quotes: Quote[] = [
        ...
        { text: "If you will never try, you will never know, your worth", author: "Fix you, Coldplay" },
        ...
        { text: "You're on your own now, We won't save you, Your rescue squad is too exhausted...", author: "Björk, Human behaviour" },
        { text: "Þú ferð þína eigin, ótroðnu slóð", author: "KK, Vegbúinn" },
        { text: "No rules to follow", author: "eurovision lagið: mama said" },
        ...
        { text: "Oooh, what a lucky man", author: "EMP, Lucky man" },
        { text: "Ain't no mountain high enough" },
        { text: "Tek að mér verkefni og kláraða", author: "Án djóks, Emmsé Gauti" },
        { text: "Þar sem er vilji, þar er vegur" },
        { text: "The first one now, will later be last", author: "The Times are a changing, Bob Dylan" },
        { text: "The present now will later be past", author: "The Times are a changing, Bob Dylan" },
        ...
        { text: "Draumarnir eru stöffið sem við nærumst öll á", author: "Litli hermaðurinn, Bubbi Morthens" },
        { text: "Big old mountain looking at me; says I'm the lucky one" },
        { text: "Ég kýs, ástina og lífið", author: "Jóhann Helgason, Ástið og lífið" },
        { text: "Don't stop me now, I'm having such a good time" },
        { text: "Light up your face with gladness, if you just smile", author: "Smile" },
        { text: "Nobody said it was easy", author: "The Scientists, Coldplay" },
        { text: "We're so happy and that's how we're gonna stay", author: "Do wah diddy diddy" }
    ];
