...
export class QuoteService {
    private static quotes: Quote[] = [
        ...
        { text: "Ferðin verður löng, en gatan virðist greið.", author: "Botnleðja" },
        ...
        { text: "Þetta er jörðin sem ég ann, þetta er landið sem ég ann.", author: "Magnús Sigmundsson" },
        ...
        { text: "Don't stop me now, I'm having such a good time.", author: "Freddy Mercury" },
