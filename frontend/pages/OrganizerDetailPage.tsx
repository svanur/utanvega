                            ...
                            <Stack direction="row" spacing={0.5} alignItems="center">
                                {organizer.socialLinks
                                    ...
                                    .map((link) => {
                                        ...
                                        else if (type === 'photo') icon = <PhotoLibraryIcon fontSize="small" />;
                                        else if (type === 'itra') icon = <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M12 2L2 22h4l1.6-4h8.8l1.6 4h4L12 2zm0 6.8l2.6 6.2H9.4L12 8.8z"/></svg>;
                                        return (
