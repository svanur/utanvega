...
import { getTicketStatusColor, groupDistances, isAllSoldOut, hasRegistrationClosed, isRegistrationRequired } from '../utils/ticketStatus';
                        ...
                        if (row.kind === 'series-race') {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell align="center">
                                        {race.registrationUrl && raceDaysUntil !== null && raceDaysUntil >= 0 && isRegistrationRequired(event.registrationStatus) ? (
